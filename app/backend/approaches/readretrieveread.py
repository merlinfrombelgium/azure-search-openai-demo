...
class ReadRetrieveReadApproach(Approach):
    ...
    template_prefix = \
"You are an intelligent assistant helping OB-V-US and V-care employees with their questions about the company structure and policies. " \
...
Thought: {agent_scratchpad}"""    
    ...
    CognitiveSearchToolDescription = "useful for searching the OB-V-US and V-care employee information such as car policy, house rules, etc."
